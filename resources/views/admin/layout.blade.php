...
<head>
  ...
  <title>Adminstrador | Starter</title>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="{{ asset('images/login/persona.jpg') }}" class="user-image" alt="User Image">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="{{ asset('images/login/persona.jpg') }}" class="img-circle" alt="User Image">
        </div>
...
<!-- jQuery 3 -->
<script src="{{ asset('adminlte/plugins/jquery.js') }}"></script>
<!-- Bootstrap 3.3.7 -->
